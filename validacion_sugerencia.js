var txtNombreD, txtApellidoD, txtTelefonoD, txtEmailD, txtSugerenciaD, btnEnviarD;
...
window.onload = function(e)
{
  ...
  txtSugerenciaD = document.getElementById("subject");
  ...
  btnEnviarD.addEventListener('click', function(e)
{
  ...
  var txtSugerenciaValue = txtSugerenciaD.value;
  ...
  if((/^\s*$/).test(txtSugerenciaValue))
  {
    validado = false;
    alert("La sugerencia es requerido")
  }
  ...
  if((/^[a-zA-Z0-9\s,.'-]{3,}$/).test(txtSugerenciaValue))
  {
  ...
  {
    validado = false;
    alert("La sugerencia tiene valores incorrectos");
  }
